...
<template>
  <div class="hepan-analysis-container">
    ...
    <div class="persons-container">
      ...
      <div class="person-card">
        ...
        <div class="form-group">
          <label>姓名：</label>
          <input v-model="person1.name" type="text" placeholder="请输入姓名" class="form-input" />
        </div>
        ...
        <div class="form-group">
          <label>出生日期：</label>
          <input v-model="person1.birthDate" type="date" class="form-input" />
        </div>

        <div class="form-group">
          <label>出生时间：</label>
          <input v-model="person1.birthTime" type="time" class="form-input" />
        </div>
      ...
      <div class="person-card">
        ...
        <div class="form-group">
          <label>姓名：</label>
          <input v-model="person2.name" type="text" placeholder="请输入姓名" class="form-input" />
        </div>
        ...
        <div class="form-group">
          <label>出生日期：</label>
          <input v-model="person2.birthDate" type="date" class="form-input" />
        </div>

        <div class="form-group">
          <label>出生时间：</label>
          <input v-model="person2.birthTime" type="time" class="form-input" />
        </div>
    ...
    <div class="action-buttons">
      <button class="btn-secondary" @click="fillExampleData">📝 示例数据</button>
      <button class="btn-secondary" @click="resetForm">🔄 重置</button>
      <button class="btn-primary" :disabled="props.loading" @click="handleAnalyze">
